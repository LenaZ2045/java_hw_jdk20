...
public class MathQuiz {
    ...
    public void start() {
        ...
        System.out.println();
        System.out.println("Congratulations player #" + players[0] + "! " + name1 + ", you completed three MATH QUIZZES! Points you earned " + score[0]);
        System.out.println("Congratulations player #" + players[1] + "! " + name2 + ", you completed three MATH QUIZZES! Points you earned " + score[1]);
    }
}
